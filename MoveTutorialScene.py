...
class MoveTutorialScene(SceneBase):
	def __init__(self):
		super().__init__()
		self.image = None
		...
		self.indicatorHint = GameObject.GameObject()
	...
	def init(self):
		...
		ResourceManager.instance.load("MoveHint1", "image", "Hint_Move2.png")
		ResourceManager.instance.load("MoveHint2", "image", "Hint_Standby.png")
		ResourceManager.instance.load("IndicatorHint", "image", "Hint_ClickEnemy.png")
		...
		# attack hint
		self.indicatorHint.init(ResourceManager.instance.getResourceHandler("IndicatorHint"), (435, 100), (304, 189)) 
		self.attackHint.init(ResourceManager.instance.getResourceHandler("MoveHint1"), (248, 430), (306, 110)) 
		self.attackHintCursor1.init(ResourceManager.instance.getResourceHandler("HintCursor1"), (300, 445), (28, 35))
	...
	def start(self):
		...
		BattleCore.instance.loadStatus("MoveTutorialData.txt")

		self.indicator.setFocus((2, 6), self.status.board.getCharacByPos((2, 6)))
	...
	def update(self, events):
		...
		if self.waitForAttackOpt:
			self.attackHint.position = (248, 309)[:]
			self.attackHintCursor2.position = (800, 600)[:]
			self.attackHint.changeAvatar(ResourceManager.instance.getResourceHandler("MoveHint2"))
	...
	def draw(self):
		...
		self.indicatorHint.draw(self.screen)
	...
	def destroy(self):
		...
		ResourceManager.instance.unload("IndicatorHint")
		ResourceManager.instance.unload("MoveHint1")
		ResourceManager.instance.unload("MoveHint2")
